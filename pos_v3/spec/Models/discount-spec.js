describe('Discount: ', function () {
    ...
    describe('SingleDiscount ', function () {
        ...
        it('should be able to constructed correctly.', function () {
            expect(discount.type).toEqual(Discount.types.single);
            expect(discount.discount).toEqual(0.5);
    ...
    describe('BrandDiscount ', function () {
        ...
        it('should be able to constructed correctly.', function () {
            expect(discount.type).toEqual(Discount.types.brand);
            expect(discount.discount).toEqual(0.5);
    ...
    describe('FullDiscount ', function () {
        ...
        it('should be able to constructed correctly.', function () {
            expect(discount.type).toEqual(Discount.types.full);
            expect(discount.discount).toEqual(0.5);
